PROCEDURE populate_endos_rsk_dtls071018 (
...
IS
   CURSOR cur_ipu
   IS
      SELECT DISTINCT ipu_code, ipu_property_id, ipu_item_desc, ipu_qty,
                      ...
                      ipu_quz_code, ipu_quz_sht_desc, ipu_sht_desc, ipu_id,
                      ipu_bind_code, ipu_excess_rate, ipu_excess_type,
                      ipu_excess_rate_type, ipu_excess_min, ipu_excess_max,
                      ipu_prereq_ipu_code, ipu_escalation_rate,
                      ipu_comm_rate, ipu_prev_batch_no, ipu_cur_code,
                      ipu_relr_code, ipu_relr_sht_desc, ipu_pol_est_max_loss,
                      ...
                      ipu_comp_retention, ipu_bp, ipu_fp,
                      ...
                      ipu_override_ri_retention, ipu_conveyance_type,
                      ...
                      ipu_prev_tot_nonprorata_s_prem, ipu_status,
                      ipu_cover_suspended, ipu_suspend_wef, ipu_suspend_wet,
                      ipu_install_period, ipu_pymt_install_pcts, ipu_rs_code,
                      ipu_rescue_mem, ipu_rescue_charge, ipu_instal_prem,
                      ipu_health_tax, ipu_road_safety_tax, ipu_certchg,
                      ipu_motor_levy, ipu_client_vat_amt, ipu_cashback_appl,
                      ipu_cashback_level, ipu_vehicle_model,
                      ipu_vehicle_make, ipu_vehicle_model_code,
                      ipu_vehicle_make_code, ipu_loc_town, ipu_prop_address, ipu_risk_note, ipu_other_com_charges, ipu_model_yr,
   ...
   CURSOR risk_commissions (v_ipu NUMBER)
   IS
      SELECT *
...
--       RAISE_ERROR('v_action_type '||v_action_type||' v_old_batch_no '|| v_old_batch_no||' v_old_ipu_code '||v_old_ipu_code );
   ...
   BEGIN
      SELECT pol_policy_no, pol_ren_endos_no, pol_wef_dt, pol_wet_dt,
             pol_uw_year, pol_policy_cover_from, pol_policy_cover_to,
             pol_tot_instlmt, pro_expiry_period, pol_paid_to_date, 
             pro_cert_period, pol_pymt_install_pcts 
        INTO v_new_pol_no, v_new_endr_no, v_pol_wef, v_pol_wet,
             v_pol_uw_year, v_pol_cover_from, v_pol_cover_to,
             v_pol_tot_instlmt, v_pro_expiry_period, v_pol_instal_wet,
             v_certificate_period, v_pol_pymt_install_pcts
