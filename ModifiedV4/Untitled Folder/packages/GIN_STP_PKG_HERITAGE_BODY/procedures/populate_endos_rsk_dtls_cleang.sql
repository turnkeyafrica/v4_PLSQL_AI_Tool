   ...
   IS
      ...
      IS
         SELECT DISTINCT ipu_code, ipu_property_id, ipu_item_desc, ipu_qty,
                         ...
                         ipu_id, ipu_bind_code, ipu_excess_rate,
                         ...
                         ipu_accumulation_limit, ipu_reinsure_amt,
                         ipu_compute_max_exposure, ipu_paid_premium,
                         ipu_trans_count, ipu_paid_tl, ipu_inception_uwyr,
                         ipu_endos_remove, ipu_eml_based_on,
                         ...
                         ipu_cover_suspended, ipu_suspend_wef,
                         ipu_suspend_wet, ipu_install_period,
                         ipu_pymt_install_pcts, ipu_rs_code, ipu_rescue_mem,
                         ipu_rescue_charge, ipu_instal_prem,ipu_health_tax, 
                         ipu_road_safety_tax,ipu_certchg,ipu_motor_levy,ipu_client_vat_amt
