```sql
PROCEDURE pop_loading_rsk_limits (
...
BEGIN
    ...
    IF NVL (v_pol_binder, 'N') != 'Y' THEN
        FOR pil_cur_rec IN pil_cur LOOP
            BEGIN
                SELECT DISTINCT
                    scvts_order,
                    scvts_calc_group
                ...
                WHERE
                        scvts_sect_code = pil_cur_rec.sect_code
        ...
        FOR pil_cur_ncd_rec IN pil_cur_ncd LOOP
            BEGIN
                SELECT DISTINCT
                    scvts_order,
                    scvts_calc_group
                ...
                FROM
                    gin_subcl_covt_sections
                WHERE
                        scvts_sect_code = pil_cur_ncd_rec.pil_sect_code
                    AND scvts_scl_code = v_scl_code
                    AND scvts_covt_code IN (
                        SELECT
                            ipu_covt_code
            ...
            WHERE
                pil_code = pil_cur_ncd_rec.pil_code;
