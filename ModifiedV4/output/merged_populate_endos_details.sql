...
BEGIN
   ...
   END;
    ...
    LOOP
       ...
       checkagentstatus(cur_endors_pol_rec.pol_agnt_agent_code,v_trans_type);
...
code,
	  ...
	  FOR cur_subclass_conditions_rec IN cur_subclass_conditions(v_old_pol_batch_no)
        LOOP
            BEGIN
...
```sql
        ...
        LOOP
            ...
            LOOP
                ...
                ELSE
					IF NVL(v_trans_type,'NB') = 'EX' AND v_param_ext = 'Y' THEN
                    ...
                    INSERT INTO gin_insured_property_unds (
                         ...
                         VALUES (
                                   ...
                                   --DECODE(v_trans_type,'DC',cur_ipu_rec.IPU_PAID_TL,DECODE(NVL(cur_ipu_rec.IPU_ENDOS_REMOVE,'N'),'N',cur_ipu_rec.IPU_PAID_TL,0)),
									...
									cur_ipu_rec.ipu_prev_prorata_sect_prem,
                                    cur_ipu_rec.ipu_prev_nonprorata_sect_prem,
                                    cur_ipu_rec.ipu_tot_prorata_sect_prem,
                                    cur_ipu_rec.ipu_tot_nonprorata_sect_prem,
									cur_ipu_rec.ipu_prev_tot_prorata_s_prem,
                                    cur_ipu_rec.ipu_prev_tot_nonprorata_s_prem,
