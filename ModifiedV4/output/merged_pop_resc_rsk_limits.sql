...
BEGIN
    ...
    BEGIN
        SELECT
            rss_apply_as_discount
        INTO
            v_apply_as_discount
        FROM
            gin_resc_srv_subcl
        WHERE
            rss_rs_code = v_rs_code
            AND rss_scl_code = v_scl_code;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    FOR pil_cur_rec IN pil_cur LOOP
        ...
        BEGIN
            ...
            FROM
                gin_subcl_sections
            WHERE
                sec_sect_code = pil_cur_rec.sect_code
        ...
        BEGIN
            INSERT INTO gin_policy_insured_limits (
                ...
                1,
                NULL,
                DECODE(pil_cur_rec.prr_rate_type, 'SRG', 0, 'RCU', 0, pil_cur_rec.prr_rate),
                0,
    ...
    IF NVL (v_row, 0) = 0 AND NVL (v_apply_as_discount, 'N') = 'Y' THEN
