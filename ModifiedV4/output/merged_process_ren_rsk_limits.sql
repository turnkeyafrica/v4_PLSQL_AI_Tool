```sql
PROCEDURE process_ren_rsk_limits (
    ...
    THEN
        BEGIN
            INSERT INTO gin_ren_policy_insured_limits (
                ...
                pil_desc, pil_row_num, pil_calc_group, pil_limit_amt,
                pil_prem_rate, pil_prem_amt, pil_rate_type, pil_rate_desc,
                pil_sect_type, pil_original_prem_rate, pil_multiplier_rate,
                pil_multiplier_div_factor, pil_annual_premium,
                pil_rate_div_fact, pil_compute, pil_prd_type, pil_dual_basis,
                pil_prem_accumulation, pil_declaration_section, pil_comment,
                pil_free_limit, pil_limit_prd
            )
            VALUES (
                gin_pil_code_seq.NEXTVAL, v_new_ipu_code, v_sect_code,
                v_sect_sht_desc, v_sect_desc, v_row,
                ...
                NVL (v_rsk_sect_data (1).pil_prem_amt, 0), v_prr_rate_type,
                v_prr_rate_desc, v_sect_type, v_prr_rate,
                NVL (
