...
BEGIN
    ...
    -- Check if the procedure should use the old logic or the new logic
    IF v_pro_code IS NULL THEN -- If v_pro_code is null, use the new logic with update_mandatory_sections
        update_mandatory_sections (v_qr_code,
                                   ...
                                   'N',
                                   'Q');
    ELSE -- if v_pro_code is not null then use old logic.
        v_row := 0;
